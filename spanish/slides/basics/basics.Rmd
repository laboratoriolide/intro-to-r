...
#.large[.fontone[.left[.opaco[Introducción a R]]]]

### .center[.large[.fontone[.red[Conceptos Fundamentales]]]]
...
### .right[.opaco[.extralarge[<br>.fontone[Daniel Sánchez Pazmiño<br> Especialización en Investigación Científica UNEMI 2024]]]]
··
...
## .weight[.fontone[.nd[.left[R para investigación]]]]

--

<div class="left fontone opaco large">
<ul style="list-style-type: disc">
<li>R y otro software programático han ido tomando importancia para la investigación</li> 
<br>
<li>La utilización de código vs. el uso de clicks permite una detección de errores más simple</li>
<br>
<li>Las revistas académicas exigen reproducibilidad de resultados</li>
<br>
<li>R es un software abierto, lo que da transparencia</li>
<br>
<li>Como software gratuito, menos desigualdad en acceso</li> 
<br>
<li>La mayoría de métodos estadísticos están implementados en R</li> 
<br>
<li></li> 
</ul>
</div>
...
<div class="left fontone opaco large">
<ul style="list-style-type: disc">
<li> R es el lenguaje de programación (base) o el RGui
<br>
<li> En principio, no se necesita nada más que el RGui para programar en R
<br>
<li> RStudio es un entorno de desarrollo integrado (EDI) gratuito y de código abierto que facilita la programación en R
<br>
<li> RStudio tiene botones y menús (una interfaz de usuario, UI) que facilitan el uso del lenguaje
</ul>
</div>
...
<div class="left fontone opaco large">
<ul style="list-style-type: disc">
<li> Establecer el directorio de trabajo con `setwd()`</li> 
<br>
<li> Trabajar con funciones especiales (ej. `here()`)</li>
<br>
<li>Lo mejor: utilizar proyectos de RStudio (`.Rproj`)</li>
</ul>
</div>
