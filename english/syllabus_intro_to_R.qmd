...
- [R for the Rest of Us](https://book.rfortherestofus.com/): A great resource on learning all those things about R which aren't about statitsics or data analysis, like package development, web scraping, accesing data, creating websites, etc.
