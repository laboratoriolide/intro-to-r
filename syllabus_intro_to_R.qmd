...
- **Lecture 1**: Intro
    ...
    - Basic R syntax: variables, assigners, data types, structures, and operators.
    - Data frames: manipulating with base R syntax.
    - Loading data from packages, GitHub, local files, and the web.
...
- **Lecture 2**: Data manipulation
     ...
     - Importing data with `readr`/`readxl` from different file formats
     - Looking at dirty data: missing values, duplicates, outliers
