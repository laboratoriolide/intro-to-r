...
- **Lecture 1**: Intro
    ...
    - **Complete before class**: Read the full syllabus, installation of R and RStudio, cloning of the course's GitHub repository and completion of the first DataCamp course, *Introduction to R for Finance*.
...
- **Lecture 2**: Introduction to the tidyverse and importing data
     ...
     - Complete before class: DataCamp course *Introduction to importing data in R* and *Introduction to the Tidyverse*. and make sure you have access to the module's `data` folder in the GitHub repository. 
