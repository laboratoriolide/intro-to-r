...
- An analysis of replication files in [Sebastian Kranz'] replication database finds that both R and Python files have increased in the last years, yet are still a minority compared to Stata and Matlab.
